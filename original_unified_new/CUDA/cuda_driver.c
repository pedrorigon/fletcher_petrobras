...
void DRIVER_Finalize(float *restrict vpz, float *restrict vsv, float *restrict epsilon, float *restrict delta, float *restrict phi, float *restrict theta)
{
	CUDA_Finalize(vpz, vsv, epsilon, delta, phi, theta);
}
