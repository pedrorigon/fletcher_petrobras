...
void DumpFieldToFile(int sx, int sy, int sz, int ixStart, int ixEnd, int iyStart, int iyEnd, int izStart, int izEnd, float d1, float d2, float d3, float *arrP, char *fName) {
...
SlicePtr OpenSliceFile(int ixStart, int ixEnd, int iyStart, int iyEnd, int izStart, int izEnd, float dx, float dy, float dz, float dt, char *fName) {
...
void DumpSliceFile(int sx, int sy, int sz, float *arrP, SlicePtr p) {
...
void   DumpSliceSummary(int sx, int sy, int sz, SlicePtr p, float dt, int it, float *arrP, float src) {
