...
static block_size sizes[] = {{2, 2}, {2, 4}, {2, 8}, {2, 16}, {2, 32}, {2, 64}, {2, 128}, {2, 256}, {4, 2}, {4, 4}, {4, 8}, {4, 16}, {4, 32}, {4, 64}, {4, 128}, {8, 2}, {8, 4}, {8, 8}, {8, 16}, {8, 32}, {8, 64}, {16, 2}, {16, 4}, {16, 8}, {16, 16}, {16, 32}, {32, 2}, {32, 4}, {32, 8}, {32, 16}, {64, 2}, {64, 4}, {64, 8}, {128, 2}, {256, 2}};
