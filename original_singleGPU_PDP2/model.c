  ...
  for (int it=1; it<=st; it++) {
    ...
    if (it <= POPULATION_SIZE)
    {
    	...
    	DRIVER_Propagate(  sx,   sy,   sz,   bord,
		       dx,   dy,   dz,   dt,   it,
		       pp,    pc,    qp,    qc, populacao[it - 1].thread_x, populacao[it - 1].thread_y);
    ...
    else if (it <= POPULATION_SIZE*2)
    {
    	...
    	DRIVER_Propagate(  sx,   sy,   sz,   bord,
		       dx,   dy,   dz,   dt,   it,
		       pp,    pc,    qp,    qc, populacao[it - POPULATION_SIZE - 1].thread_x, populacao[it - POPULATION_SIZE - 1].thread_y);
    ...
    else if (it <= POPULATION_SIZE*3)
    {
    	...
    	DRIVER_Propagate(  sx,   sy,   sz,   bord,
		       dx,   dy,   dz,   dt,   it,
		       pp,    pc,    qp,    qc, populacao[it - 1 - 2 * POPULATION_SIZE].thread_x, populacao[it - 1 - 2 * POPULATION_SIZE].thread_y);
