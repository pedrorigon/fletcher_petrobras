...
#pragma acc enter data create(   pDx[0:sx*sy*sz])
  pDy=(float *) malloc(sx*sy*sz*sizeof(float));
#pragma acc enter data create(   pDy[0:sx*sy*sz])
  qDx=(float *) malloc(sx*sy*sz*sizeof(float));
#pragma acc enter data create(   qDx[0:sx*sy*sz])
  qDy=(float *) malloc(sx*sy*sz*sizeof(float));
#pragma acc enter data create(   qDy[0:sx*sy*sz])
}
	       ...
	       float * restrict pp, float * restrict pc, float * restrict qp, float * restrict qc)
{
	   ...
	   OPENACC_PropagateDer1Der1ORIG (  sx,   sy,   sz,   bord,
	                              dx,   dy,   dz,   dt,   it,
	                              pp,   pc,   qp,   qc);
