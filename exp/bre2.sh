...
bsize_x_values=(4 8 16 4 8 16 32 4 8 16 32 48 24 12 6 4 8 16 32 64 4 8 16 32 80 40 20 10 4 8 16 32 64 6 12 24 48 96 4 8 16 32 14 28 56 112 4 8 13 32)
bsize_y_values=(16 8 4 32 16 8 4 48 24 12 6 4 8 16 32 64 32 16 8 4 80 40 20 10 4 8 16 32 96 48 24 12 6 64 32 16 8 4 112 56 28 14 32 16 8 4 128 64 32 16)
    ...
    for index in "${!bsize_x_values[@]}"; do
        ...
        for run in $(seq 1 $num_runs); do
            if [[ $app == *"OpenACC"* ]]; then
                ...
                ./$app TTI 344 344 344 16 12.5 12.5 12.5 0.001 0.005 $bsize_x $bsize_y | grep "MSamples/s"
            ...
            result=$( { ./$app TTI 344 344 344 16 12.5 12.5 12.5 0.001 0.005 $bsize_x $bsize_y; } 2>&1 )
